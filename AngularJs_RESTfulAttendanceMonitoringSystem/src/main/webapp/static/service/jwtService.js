/**
 * used to convert JWT Token from HttpInterceptor to base64 encode/decode
 * and get Expiration date 
 * 
 */
app.factory('jwtService',function($window) {
	...
	function getTokenExpirationDate(token) {
		...
		console.log('token expiration=', d);
		return d;
	};
